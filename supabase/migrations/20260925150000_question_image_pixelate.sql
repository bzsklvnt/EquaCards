-- Pixeles képfelfedés (élő teszt utáni kör): kérdésenkénti kapcsoló, NEM
-- külön kérdéstípus — a pixelezés a kép megjelenítését szabályozza, a
-- válaszadás módját továbbra is a question_type_id adja, így bármely
-- típussal kombinálható, és a meglévő időalapú pontcsökkenés (points_decay)
-- magától jutalmazza a korai tippet. Lásd docs/features/pixel-reveal.md.
alter table public.questions
  add column image_pixelate boolean not null default false;

-- A current_question_state() (Fázis P4 reconnect-restore) is visszaadja a
-- kapcsolót, hogy egy újracsatlakozó csapat/TV ugyanúgy pixelesen lássa a
-- képet. A függvény többi része változatlan a
-- 20260810120000_current_question_state_option_images.sql-hez képest.
