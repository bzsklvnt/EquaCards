<script lang="ts">
	...
	// használja (nincs games sorhoz kötve, mint a host/csapat/TV) — ugyanaz a
	// token-feloldás, csak design_theme_id nélkül.
	onMount(() => {
...
<div class="admin-shell" style={themeCss}>
	...
	<aside class="sidebar" id="admin-sidebar" class:open={mobileNavOpen}>
		...
		<nav>
			...
			{/if}
			<div class="nav-divider"></div>
			<a href={resolve('/reports')}>Riportok</a>
		</nav>

		<div class="sidebar-footer">
			<span class="user">{data.profile.display_name}</span>
